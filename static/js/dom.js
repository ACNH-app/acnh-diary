...
export const encyclopediaPanel = document.getElementById("encyclopediaPanel");
export const encyclopediaMonthLabel = document.getElementById("encyclopediaMonthLabel");
export const monthlyTargetsCard = document.getElementById("monthlyTargetsCard");
export const monthlyTargetsSummary = document.getElementById("monthlyTargetsSummary");
export const monthlyTargetsList = document.getElementById("monthlyTargetsList");
export const encyclopediaShortcutButtons = Array.from(document.querySelectorAll(".encyclopedia-shortcuts [data-mode]"));
...
export const catalogToggleDonatedBtn = document.getElementById("catalogToggleDonatedBtn");
...
export const catalogDonatedTabs = Array.from(document.querySelectorAll("#catalogDonatedTabs .tab"));
