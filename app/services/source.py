...
FROM_MAP_KO = {
    ...
    "dj kk concert": "DJ K.K. 공연(해피홈 파라다이스에서 옷가게 완공 후)",
    "k.k. concert": "DJ K.K. 공연(해피홈 파라다이스에서 옷가게 완공 후)",
    "group stretching": "그룹 체조(하루에 한 번 씩 그룹체조 50번 한 후)",
    "hip reaction collection": "최신 유행! 리액션 도감(너굴포트, 2700마일)",
    "jack": "펌킹",
    "jock villagers": "운동광 주민",
    "lazy villagers": "먹보 주민",
    "new reactions notebook": "리액션 아이디어 노트(너굴포트, 3300마일)",
    "normal villagers": "친절함 주민",
    "peppy villagers": "아이돌 주민",
    "smug villagers": "느끼함 주민",
    "snooty villagers": "성숙함 주민",
    "viva festivale reaction set": "비바! 카니발 리액션(너굴쇼핑, 23760벨)",
