...
class MetaHandlerDeps:
    ...
    list_islands: Callable[[], list[dict[str, Any]]]
    create_island: Callable[[str], dict[str, Any]]
    delete_island: Callable[[int], dict[str, Any]]
    get_island_profile: Callable[[int], dict[str, Any]]
    upsert_island_profile: Callable[..., dict[str, Any]]
    list_calendar_entries: Callable[[int, str], list[dict[str, Any]]]
    list_calendar_entries_by_date: Callable[[int, str], list[dict[str, Any]]]
    upsert_calendar_entry: Callable[..., dict[str, Any]]
    update_calendar_entry_checked: Callable[..., dict[str, Any]]
    delete_calendar_entry: Callable[[int, int], dict[str, Any]]
    list_players: Callable[[int], list[dict[str, Any]]]
    upsert_player: Callable[..., dict[str, Any]]
    set_main_player: Callable[[int, int], dict[str, Any]]
    delete_player: Callable[[int, int], dict[str, Any]]


@dataclass(frozen=True)
class VillagerHandlerDeps:
    load_villagers: Callable[[], list[dict[str, Any]]]
    with_villager_state: Callable[[int, list[dict[str, Any]]], list[dict[str, Any]]]
...
class CatalogHandlerDeps:
    ...
    with_catalog_state: Callable[[int, str, list[dict[str, Any]]], list[dict[str, Any]]]
    with_catalog_variation_counts: Callable[[int, str, list[dict[str, Any]]], list[dict[str, Any]]]
    ...
    get_catalog_variation_state_map: Callable[[int, str, str], dict[str, dict[str, Any]]]
    ...
    invalidate_catalog_state_caches: Callable[[str | None, int | None], None]
    init_db: Callable[[], None]
    get_db: Callable[..., Any]
...
class MetaHandlers:
    ...
    get_encyclopedia_monthly_targets: Callable[[int], dict[str, Any]]
    ...
    get_calendar_entries: Callable[[int, str], list[dict[str, Any]]]
    get_calendar_annotations: Callable[[int, str], list[dict[str, Any]]]
    get_calendar_entries_by_date: Callable[[int, str], list[dict[str, Any]]]
    save_calendar_entry: Callable[..., dict[str, Any]]
    set_calendar_entry_checked: Callable[..., dict[str, Any]]
    remove_calendar_entry: Callable[[int, int], dict[str, Any]]
    get_players: Callable[[int], list[dict[str, Any]]]
    save_player: Callable[..., dict[str, Any]]
    set_main_player: Callable[[int, int], dict[str, Any]]
    remove_player: Callable[[int, int], dict[str, Any]]
